    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex cursor-pointer gap-5">
          <div className="flex w-[81px] cursor-pointer flex-col gap-2">
            <select
              type="text"
              name="firstname"
              id="firstname"
              placeholder="Enter first name"
              className="rounded-lg cursor-pointer bg-richblack-700 p-3 text-[16px] leading-[24px] text-richblack-5 shadow-[0_1px_0_0] shadow-white/50 placeholder:text-richblack-400 focus:outline-none"
